            ...
            <div className="sticky top-0 z-10 bg-background/95 backdrop-blur supports-backdrop-filter:bg-background/60 border-b">
                <div className="max-w-4xl mx-auto px-4 py-8">
                    <div className="flex items-center justify-center gap-3 mb-4">
                        ...
                        <h1 className="text-4xl font-bold">Stream Text Generation</h1>
                    </div>
                        ...
                        {!completion && !isLoading && !error && (
                            <div className="flex flex-col justify-center items-center h-full min-h-[300px] text-center px-4">
                                ...
                                <p className="text-muted-foreground max-w-md">
                                    Your generated text will appear here. Start by entering a prompt below and watch the AI create content in real-time.
                                </p>
                            </div>
                        )}
                    </CardContent>
